...
import com.boutiqaat.catalogadminexportimportplus.exception.SpecificationException;
...
public class Filter {
    ...
    public static final String FIND_IN_SET = "findinset";
    public static final String NOT_FIND_IN_SET = "notfindinset";
    ...
    public Filter(String logic, List<Filter> filters) {
        this.logic = logic;
